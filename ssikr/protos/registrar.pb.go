...
type RegistrarRequest struct {
	...
	DidDocument string `protobuf:"bytes,2,opt,name=didDocument,proto3" json:"didDocument,omitempty"` // 파라미터에 들어갈 순서 go에서는 순서가 중요하다고 함
}
...
var file_protos_registrar_proto_rawDesc = []byte{
	...
	0x00, 0x42, 0x0e, 0x5a, 0x0c, 0x73, 0x73, 0x69, 0x6b, 0x72, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
