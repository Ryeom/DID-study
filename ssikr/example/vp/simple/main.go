...
func main() {
	...
	vc1Token := vc1.GenerateJWT(verificationId, issuerKeyEcdsa.PrivateKey)
	vc2Token := vc2.GenerateJWT(verificationId, issuerKeyEcdsa.PrivateKey)
